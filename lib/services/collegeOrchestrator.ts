...
6. STRICT EDUCATION LEVEL MATCHING: The user currently holds or is completing the Education Level: ${profile.educationLevel}. You MUST tailor all your descriptions and 'recommendedStreams' reasons strictly for the logically NEXT level (e.g., if they currently hold a Master's/PG, explicitly mention advanced research and Ph.D./Doctorate studies. NEVER output "for PG studies" or "for UG studies" if the user is already a PG or PhD candidate).
