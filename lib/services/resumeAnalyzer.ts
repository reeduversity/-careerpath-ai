...
export function analyzeResumeTextFallback(text: string) {
  const result = {
    ...
    careerGoal: null as string | null,
    targetJobRole: null as string | null,
...
Schema:
{
  ...
  "industry": "string | null (detect domain)",
  ...
  "tenthPercentage": "string | null (e.g. '88', look for 10th, SSC, Matriculation, Secondary)",
  "twelfthPercentage": "string | null (e.g. '88.2', look for 12th, HSC, Intermediate, Senior Secondary)",
  "category": "string | null (Extract social category ONLY if explicitly mentioned: General, OBC, SC, ST. Otherwise null)",
  "experienceLevel": "string | null (Calculate total experience duration from dates and map to strictly ONE of: 'Fresher', '0-1 Years', '1-3 Years', '3-5 Years', '5+ Years')",
